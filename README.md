...
[![Dataset](https://img.shields.io/badge/🤗%20Dataset-GUI--Agent--Trajectories-yellow)](https://huggingface.co/datasets/WenyiWU0111/GUI-Agent-Trajectories)
...
- 💰 **Cost-effective**: Collect 10K trajectories for ~$500
...
- **Cost-effective**: Collected for approximately **$xxx** using our automated pipeline
...
- GitHub Issues: [Create an issue](https://github.com/yourusername/GUI-Agent/issues)
- Email: wew058@ucsd.edu
